document.addEventListener('DOMContentLoaded', function() {
    // Sample class data
    const classes = [
        { id: 1, name: 'Grade 10 - A', teacher: 'Dr. Sarah Johnson', students: 32, subject: 'Science' },
        { id: 2, name: 'Grade 11 - B', teacher: 'Mr. David Wilson', students: 28, subject: 'Mathematics' },
        { id: 3, name: 'Grade 9 - C', teacher: 'Ms. Emily Brown', students: 30, subject: 'English' }
    ];
