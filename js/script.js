document.addEventListener('DOMContentLoaded', function() {
    ...
    const activities = [
        ...
        { date: '2023-06-03', activity: 'Payment', user: 'Michael Brown', details: 'Paid tuition fees' },
        { date: '2023-06-04', activity: 'New Teacher', user: 'Admin', details: 'Hired new math teacher' }
    ];
    ...
    navItems.forEach(item => {
        item.addEventListener('click', function() {
            navItems.forEach(i => i.classList.remove('active-nav-item', 'bg-blue-700'));
