    ...
    document.addEventListener("DOMContentLoaded", function () {
              ...
              <div class="student-card">
                ...
                <div class="student-info">
                  ...
                  <div class="student-details">
                    <span><i class="fas fa-envelope mr-1"></i>${student.email}</span>
                    <span><i class="fas fa-phone mr-1"></i>${student.phone}</span>
                    <span class="grade-badge badge-${student.grade}">
      ...
      function editStudent(id) {
        ...
        if (student) {
          ...
          studentForm.querySelector('select[name="section"]').value = student.section;
