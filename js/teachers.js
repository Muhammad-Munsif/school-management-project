    ...
    document.addEventListener("DOMContentLoaded", function () {
              ...
              <div class="teacher-card">
                ...
                <div class="teacher-info">
                  ...
                  <div class="teacher-details">
                    <span><i class="fas fa-envelope mr-1"></i>${teacher.email}</span>
                    <span><i class="fas fa-phone mr-1"></i>${teacher.phone}</span>
                    <span class="subject-badge badge-${teacher.subject.toLowerCase()}">
                      ${teacher.subject}
                    </span>
                  </div>
      ...
      function editTeacher(id) {
        ...
        if (teacher) {
          ...
          teacherForm.querySelector('select[name="subject"]').value = teacher.subject;
          editingTeacherId = id;
          modal.classList.remove("hidden");
        }
      }
